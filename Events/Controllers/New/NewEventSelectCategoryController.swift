//
//  NewEventSelectCategoryController.swift
//  Events
//
...
class NewEventSelectCategoryController: TableNodeController {
    
    var eventModel: EventModel?
    
    private var content: [Int: [NewEventCategory]] = [
        0: [
            .business, .travel, .birthday, .wedding, .other
        ]
    ]
